  ...
  return (
    <main className="max-w-6xl mx-auto px-8 py-12">
      <section className="mb-12">
        <h2 className="text-[32px] font-bold text-white mb-2 font-manrope">Role Play</h2>
      ...
      {scenarioList ? (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          <aside className="lg:col-span-4 space-y-4">
            <h3 className="text-xl font-bold text-white mb-4 font-manrope">Select Scenario</h3>
              ...
              <div className="p-8 rounded-2xl bg-surface-container border-l-4 border-tertiary space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-4 bg-white/5 rounded-xl space-y-2 text-on-surface">
