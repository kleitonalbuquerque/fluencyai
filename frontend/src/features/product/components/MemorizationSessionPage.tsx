...
export function MemorizationSessionPage() {
  ...
  return (
    <div className="min-h-screen bg-[#09090B] text-on-surface font-inter antialiased overflow-x-hidden">
      <Sidebar user={session?.user} />
      <AppHeader user={session?.user} title="Memorization" />
                ...
                <div className="relative bg-[#121217] border border-white/10 rounded-xl overflow-hidden shadow-2xl">
                  ...
                  <div className="w-full h-48 relative overflow-hidden">
                    <img 
                      ...
                      src="https://images.unsplash.com/photo-1558244661-91481c3249c2?auto=format&fit=crop&w=800&q=80" 
                    />
                  ...
                  <div className="px-8 pb-10 pt-4">
                    <div className="flex justify-between items-start mb-6">
                      <h3 className="text-[48px] font-bold text-white font-manrope">{sessionData.words[0].word}</h3>
